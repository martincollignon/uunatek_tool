...
class GeminiClient:
    ...
    async def edit_image(
        ...
        edit_prompt = (
            ...
            f"{prompt} "
            "The output image must use ONLY black lines on a completely white background. "
            "NO blue, NO colors, NO grays - ONLY pure black (#000000) and completely white (#FFFFFF) background. "
            ...
            "- Background must be COMPLETELY WHITE #FFFFFF with absolutely zero texture\n"
    ...
    def _enhance_prompt_for_plotter(
        ...
        return (
            ...
            "Use ONLY black line outlines on a COMPLETELY WHITE #FFFFFF background. "
            ...
            "CRITICAL: Use THIN, CONSISTENT line widths throughout the entire drawing - "
            "imagine using a single fine-tip pen (0.3-0.5mm) for the entire image. "
            "Avoid thick or bold lines, and maintain uniform stroke thickness for all outlines and details. "
            "Think of it as a drawing made by a single fine pen on completely white #FFFFFF paper. "
            ...
            "The background MUST be completely white #FFFFFF with no texture or tint."
        )
